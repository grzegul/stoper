...
public class ObslugaBreakTestAllFactorized {
    MainActivity ma = new MainActivity();
    private String expected;
    private String actual;

    public ObslugaBreakTestAllFactorized(String expected, String actual) {
    ...
    public void obslugaTime_checkIfDataIsCorrect_acceptedData(){
        assertEquals(expected, ma.obslugaBreak(actual));
    }
